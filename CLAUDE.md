...
./build/cpp/miniscript examples/test_calls.msa           # Clean output
./build/cpp/miniscript --debug examples/test_calls.msa   # Verbose debug output
./build/cpp/miniscript --test                            # Unit + integration test suites
./build/cpp/miniscript --help                            # Full option list
```
