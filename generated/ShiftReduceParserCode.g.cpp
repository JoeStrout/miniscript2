...
#include "ShiftReduceParserCode.g.h"
...
AcceptExceptionStorage::AcceptExceptionStorage() {
        ...
        protected static void YYAccept() { throw  AcceptException(); }
        ...
        protected static void YYAbort() { throw  AbortException(); }
        ...
        protected static void YYError() { throw  ErrorException(); }
        ...
        /// Abstract base method. ShiftReduceParser calls AcceptException(shared_from_this())

        /// to initialize the base class data structures.  Concrete

        /// parser classes must override AcceptException(shared_from_this()) method::
        ...
        public bool Parse() {
            ...
            while (true) {
                ...
                if (FsaState::!IsNull(ParserTable)) {
        ...
        private void Reduce( int ruleNumber ) {
            ...
            if (rhLen == 1) {
                ...
                // Explicit semantic action may mutate AcceptException(shared_from_this()) value
                ...
                // previous lexeme.  This gives the correct behaviour when AcceptException(shared_from_this())

                // nonsense value is used in later Merge operations::

                CurrentLocationSpan = (scanner::!IsNull(yylloc) && !IsNull(LastSpan) ?
                ...
                CurrentLocationSpan =
                    ...
                    ((!IsNull(at1) && !IsNull(atN)) ? at1::Merge( atN ) : default( TSpan ));
        ...
        private void ReportError() {
            ...
            StringBuilder errorMsg =  StringBuilder();
    ...
    /// Classes implementing AcceptException(shared_from_this()) interface must supply a

    /// method that merges two location objects to return

    /// a  object of the same type::
...

 {
    ...
    /// will expect to deal with AcceptException(shared_from_this()) type::
...

 {
        ...
        public LexLocation Merge( LexLocation last ) { return  LexLocation( this::startLine, this::startColumn, last::endLine, last::endColumn ); }
 ...
 where TSpan : IMerge<TSpan> {
        ...
        // A field must be declared for AcceptException(shared_from_this()) value of parametric type,
...
#pragma warning restore 649
    ...
    public class State {
        ...
        /// The index of AcceptException(shared_from_this()) state in the states array::
        ...
        /// State transition data for AcceptException(shared_from_this()) state. Pairs of elements of the 
        ...
        public State( int[] actions, int[] goToList )
            ...
            : AcceptException(shared_from_this())( actions ) {

            Goto =  Dictionary<int, int>();
        ...
        /// Action data for AcceptException(shared_from_this()) state. Pairs of elements of the 
        ...
        public State( int[] actions ) {
            ...
            ParserTable =  Dictionary<int, int>();
        ...
        /// Set the default action for AcceptException(shared_from_this()) state::
        ...
        /// <param name="goToList">Transitions from AcceptException(shared_from_this()) state</param>

        public State( int defaultAction, int[] goToList )

            : AcceptException(shared_from_this())( defaultAction ) {
...

 {
        ...
        public T AcceptException(shared_from_this())[int index] { get { return array[index]; } }
