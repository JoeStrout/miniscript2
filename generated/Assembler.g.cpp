...
namespace MiniScript {
		...
		Int32 Assembler::FindFunctionIndex(String name) {
		...
		FuncDef Assembler::FindFunction(String name) {
		...
		Boolean Assembler::HasFunction(String name) {
			return FindFunctionIndex(name) >= 0;
		}

		List<String> Assembler::GetTokens(String line) {
		...
		void Assembler::SetCurrentLine(Int32 lineNumber, String line) {
			CurrentLineNumber = lineNumber;
			CurrentLine = line;
		}
		
		void Assembler::ClearError() {
			HasError = false;
			ErrorMessage = "";
			CurrentLineNumber = 0;
			CurrentLine = "";
		...
		void Assembler::Error(String errMsg) {
		...
		UInt32 Assembler::AddLine(String line) {
			return AddLine(line, 0);  // Default line number
		}
		
		UInt32 Assembler::AddLine(String line, Int32 lineNumber) {
		...
		Byte Assembler::ParseRegister(String reg) {
		...
		Byte Assembler::ParseByte(String num) {
		...
		Int16 Assembler::ParseInt16(String num) {
			// Simple number parsing - could be enhanced
			Int64 result = 0;
			Boolean negative = false;
			Int32 start = 0;
		...
		Int32 Assembler::ParseInt24(String num) {
			// Simple number parsing - could be enhanced
			Int64 result = 0;
			Boolean negative = false;
			Int32 start = 0;
		...
		Int32 Assembler::ParseInt32(String num) {
			// Simple number parsing - could be enhanced
			Int64 result = 0;
			Boolean negative = false;
			Int32 start = 0;
		...
		Boolean Assembler::IsLabel(String token) {
		...
		bool Assembler::AddFunction(String functionName) {
		...
		Int32 Assembler::FindLabelAddress(String labelName) {
		...
		Int32 Assembler::AddConstant(Value value) {
		...
		Boolean Assembler::IsStringLiteral(String token) {
		...
		Boolean Assembler::NeedsConstant(String token) {
		...
		Value Assembler::ParseAsConstant(String token) {
		...
		Double Assembler::ParseDouble(String str) {
		...
		void Assembler::Assemble(List<String> sourceLines) {
		...
		Int32 Assembler::AssembleFunction(List<String> sourceLines, Int32 startLine) {
